...
var import_presentmentcurrency = require("@polar-sh/sdk/models/components/presentmentcurrency.js");
var CheckoutParams = z2.object({
  ...
  currency: z2.enum(Object.values(import_presentmentcurrency.PresentmentCurrency)).optional().nullable(),
  customerIpAddress: z2.string().optional().nullable(),
  isBusinessCustomer: z2.boolean().optional(),
  customerTaxId: z2.string().optional().nullable()
});
...
// node_modules/.pnpm/@polar-sh+adapter-utils@0.4.6/node_modules/@polar-sh/adapter-utils/dist/index.js
